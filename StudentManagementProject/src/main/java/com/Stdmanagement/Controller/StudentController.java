...
@Controller      //controller controls api requests by postman/browser
public class StudentController {
	...
	@GetMapping("student/{id}")          //get Mapping for view details by id
	...
	@DeleteMapping("student/delete/{id}")            //delete mapping for delete details by id
	...
	@PutMapping("Student/update/{id}")       //put Mapping for update details by id
